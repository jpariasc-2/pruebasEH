...
set("domain/DI/name","DI"); //special for DIR-300B/600B
...
$m_c_optional2 = $m_c_optional2."<tr><td class=l_tb>&nbsp;</td><td><input type='checkbox' name='wifi_test' value=1>".$m_wifi_test."</td></tr>";
