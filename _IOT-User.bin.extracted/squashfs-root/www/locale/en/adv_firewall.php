...
$m_title_nat_endpoint = "NAT Endpoint Filtering";
$m_udp_endpoint	= "UDP Endpoint Filtering";
$m_tcp_endpoint = "TCP Endpoint Filtering";
$m_endpoint_independent = "Endpoint Independent";
$m_address_restricted = "Address Restricted";
$m_port_address	= "Port And Address Restricted";
...
$a_dmzip_in_different_subnet = "Invalid DMZ IP Address ! The DMZ IP Address and router address should be in the same network.";
