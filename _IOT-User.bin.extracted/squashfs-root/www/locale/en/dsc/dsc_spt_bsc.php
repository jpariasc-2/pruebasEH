...
<tr>
	<td height=20>
		<p>
			<strong>Russian L2TP (Dual Access)</strong><br>
			To configure a Russian L2TP Internet connection, configure as previously described for L2TP connections.
			If any static route needs to be setup by your ISP, please refer to the &quot;Routing&quot; function in 
			&quot;ADVANCED&quot; menu for further setup.
...
<tr>
	<td height=20>
		<p>
			...
			The <?query("/sys/modelname");?> is capable of 3 types of wireless security;
			NONE, WEP and WPA/WPA2 (auto-detect).
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
...
<tr>
	<td height=20>
		<p>
			...
			WPA/WPA2 authorizes and authenticates users onto the wireless network. WPA/WPA2 uses stronger security than
			WEP and is based on a key that changes automatically at regular intervals.
		</p>
		<p>
			<strong><em>Cipher Type</em></strong> -
			The <?query("/sys/modelname");?> supports two different cipher types when WPA/WPA2 is used as the Security Type.
			...
			This means that WPA/WPA2 authentication will be used in conjunction with a RADIUS server that must be present on your network. Enter
