...
if ($router_on==1)
{
	if ($generate_start==1)
	{
		...
		echo "ifconfig eth2 txqueuelen 100\n";
		echo "ifconfig eth2 hw ether ".$wanmac." up\n";
		echo "rgdb -i -s /runtime/wan/inf:1/mac ".$wanmac."\n";
		echo "vconfig set_name_type DEV_PLUS_VID_NO_PAD > /dev/console\n";
		echo "vconfig add eth2 0	> /dev/null 2>&1\n";
		echo "vconfig add eth2 2	> /dev/null 2>&1\n";
	...
	else
	{
		...
		echo "vconfig rem eth2.2\n";
		echo "vconfig rem eth2.0\n";
