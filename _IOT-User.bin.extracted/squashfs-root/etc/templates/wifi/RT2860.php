...
/* For WiFi test: 40MHz operation in 2.4Ghz, with coexistence mechanisms */
/* After add Ralink patch, wireless driver default is off, so we need to turn it on obviously. */
$ht_discoexist = query("discoexist");
if($ht_discoexist=="1")
{
	echo "HT_BSSCoexistence=0\n";
}
else
{
	echo "HT_BSSCoexistence=1\n";	/* default: turn on */
}
